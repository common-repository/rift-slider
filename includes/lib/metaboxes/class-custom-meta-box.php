...
if (!class_exists('rift_slider_custom_meta_box')) {
    ...
    class rift_slider_custom_meta_box {
        ...
        public function add_meta_box() {
            ...
            foreach ($this->_meta_box['pages'] as $page) {
                if (apply_filters('synth_show_on', true, $this->_meta_box))
        ...
        public function show_metabox() {
            ...
            echo '<table class="form-table synth_metabox">';
    ...
    $meta_boxes = array();
    $meta_boxes = apply_filters('synth_meta_boxes', $meta_boxes);
    foreach ($meta_boxes as $meta_box) {
        $my_box = new rift_slider_custom_meta_box($meta_box);
    }
}
?>
